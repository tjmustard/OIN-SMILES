...
The SuperPRD, MiniPRD, and Hypergraph (`architecture.yml`) schemas are HACF **toolchain**
templates — not OIN-SMILES specifications. Authoritative copies live in `.agents/schemas/`:
