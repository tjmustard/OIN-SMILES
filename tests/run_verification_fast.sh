...
python tests/integration/verify_xyz_to_oin.py --limit 4 | tee "${ARTIFACTS_DIR}/integration_log.txt"
...
python tests/integration/verify_roundtrip.py --limit 4 --output-dir "$ARTIFACTS_DIR" | tee "${ARTIFACTS_DIR}/roundtrip_log.txt"
