...
def transform_xyz_content(xyz_content: str) -> str:
    ...
    try:
        ...
        new_lines = [
            f"{atom_count}",
            f"{comment} [Transformed: Rotated + Translated {translation}]",
        ]
...
class ExampleRunner:
    ...
    def _run_xyz_to_smiles(
        self, example: Example, index: int, reporter: VerificationReporter
    ) -> bool:
        print("Type: XYZ -> SMILES")
