...
| `reso_sample_definitions.json` | 19294 | `5e23389feab59a4e` | hand-assembled index: seed + membership for every sample behind a v0.4.14 figure, plus the class splits. Exists because the scratchpad they were drawn in lives under /tmp and is DELETED between sessions -- a rate without its sample is not reproducible |
...
reso_sample_definitions.json  <-  tmCAT-tmPHOTO_xyz_dataset/results-v0.4.14-lane1/reso_sample_definitions.json
...
v0413_gains_ab.json  <-  tmCAT-tmPHOTO_xyz_dataset/results-v0.4.14-lane1/v0413_gains_ab.json
