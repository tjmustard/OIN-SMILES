...
Primary sources: `docs/agentic-notes/v0.4.5/RENUMBERING_INSTABILITY_v0.4.5.md`,
`src/oinsmiles/oin/stable_stereo.py`, `tests/unit/test_stable_stereo.py`,
`tests/unit/test_stable_stereo_mirror.py`, `docs/agentic-notes/v0.4.5/PROMOTION_GATE_v0.4.5.md`,
`docs/agentic-notes/v0.4.5/V045_STATUS_2026-07-25.md`.
...
From `docs/agentic-notes/v0.4.5/PROMOTION_GATE_v0.4.5.md`, measured on `trial/v045-integration` with
