...
`docs/agentic-notes/v0.4.5/PERF_v0.4.5.md`. Note that `git log --oneline main..swimlane/v045-perf` returns **nothing** —
...
`docs/agentic-notes/v0.4.5-retrospective/LANE-encoder-speed.md`).

### Discrepancies between the sources, flagged rather than smoothed

* **`docs/agentic-notes/v0.4.5/PERF_v0.4.5.md` cites `generator3d/__init__.py:590` for `return [early_hit]`.** In current
...
* **"eta is 23% of molecules but 35.6% of CPU".** The repo's own figure is **23.3% of molecules /
  35.6% of wall clock** (`docs/agentic-notes/v0.4.5/V045_STATUS_2026-07-25.md`). The rounded "23%" also collides
...
* **`docs/agentic-notes/v0.4.5/PERF_v0.4.5.md` lists `QIDKIZ_comp_0` as "39 atoms, non-eta, 1641.4 s — still
...
Docs: `docs/agentic-notes/v0.4.5/PERF_v0.4.5.md` (this lane), `docs/GENERATION_PIPELINE.md` (pipeline context),
`docs/agentic-notes/v0.4.6/V046_HFAITHFUL_FINDINGS.md` (the six-hypothesis eta sequence and its resolution).
...
7. **Do not re-derive the eta acceptance story.** Six hypotheses, six refutations, one line of
   ...
   `docs/agentic-notes/v0.4.6/V046_HFAITHFUL_FINDINGS.md` § "RESOLVED: the eta pool cost is irreducible via acceptance"
