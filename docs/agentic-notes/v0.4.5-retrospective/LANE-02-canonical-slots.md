...
`canonical_roundtrip_key`-identical. ⚠ **Discrepancy worth knowing:** `docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md`
...
5. **Out of scope and confirmed to survive this lever:** bond-order/aromaticity perception
   ...
   Lane 8) — see `docs/agentic-notes/v0.4.5/RENUMBERING_INSTABILITY_v0.4.5.md`. `DUDREA_comp_0` is closed by
