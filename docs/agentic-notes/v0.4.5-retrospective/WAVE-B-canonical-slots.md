...
`docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md` §9: the metal's own `@SP1`/`@OH1` tag *would* be a parity against a
...
**→ [Lane 2's own report](LANE-02-canonical-slots.md); design document `docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md`.**
...
(`docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md` §6) rather than silently picking one. The supersession is total on
...
`docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md` §7a specifies the fix that would close the 23 `automorphism`
...
- **Levers:** `OIN_CANONICAL_SLOTS` and `OIN_STABLE_METAL_AC` — both **default-ON** since v0.4.5 via
  `src/oinsmiles/oin/levers.py::_DEFAULT_ON`, on the evidence in `docs/agentic-notes/v0.4.5/PROMOTION_GATE_v0.4.5.md`.
...
- **Design document:** `docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md`. Lane report:
...
5. **`canonical_slot_permutation` vs `canonical_slot_map` is a live footgun.** Any future descriptor
   ...
   `docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md` §8, and it has already been mis-cited once.
