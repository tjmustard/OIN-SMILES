...
Primary sources: `docs/agentic-notes/v0.4.5/WRONG_DONOR_v0.4.5.md`, `tests/unit/test_wrong_donor_verdict.py`,
`tools/wrong_donor_groundtruth.py`, `docs/agentic-notes/v0.4.5/V045_STATUS_2026-07-25.md` §"RESOLVED — the '7
...
LEGEND
  ...
  §7a            docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md §7a — the wider fold Lane 2 specified and declined
```
...
4. **The prior was also that a fix existed.** Lane 2's `docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md` §7a already
...
`docs/agentic-notes/v0.4.5/V045_STATUS_2026-07-25.md`'s section on the "7 wrong-donor molecules" is annotated
**"✅ RESOLVED — NOT a defect"** with an instruction to read `docs/agentic-notes/v0.4.5/WRONG_DONOR_v0.4.5.md` before
...
Lane 2's `docs/agentic-notes/v0.4.5/CANONICAL_SLOTS_v0.4.5.md` §7a specifies the fold that closes this seam and declines
...
| `docs/agentic-notes/v0.4.5/WRONG_DONOR_v0.4.5.md` | **new** (230 lines) |
| `src/**` | **untouched** |
