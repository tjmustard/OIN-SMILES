...
Primary sources: `docs/agentic-notes/injectivity/INJECTIVITY_Y3_RESIDUALS.md`,
`docs/agentic-notes/injectivity/INJECTIVITY_Y3_UNKNOWN_UNKNOWNS.md`, `docs/agentic-notes/injectivity/INJECTIVITY_Y1_OVERVIEW.md`,
`docs/agentic-notes/v0.4.5/V045_STATUS_2026-07-25.md` §"Lane 7 — fixtures + instruments".
...
- The Task-B **Line 1** tables and the final REFUTED/CONFIRMED/UNDETERMINED verdict are written
  ...
  checkout. `docs/agentic-notes/injectivity/INJECTIVITY_Y3_RESIDUALS.md` §Part 2 points at that file and states **no
...
- The **70-case residue split** (`tools/injectivity/config_split.py`) likewise writes to
  ...
  `docs/agentic-notes/v0.4.5/V045_STATUS_2026-07-25.md` lists exactly this as outstanding: *"the 70-case UU residue
  split and its hand inspection, the Task-B corpus-pair line, and the exact suite count."*
- Consequently **`docs/agentic-notes/injectivity/INJECTIVITY_Y1_OVERVIEW.md` still records "donor swap undetermined"** in
...
`docs/agentic-notes/v0.4.5/V045_STATUS_2026-07-25.md` lists "the exact suite count" as outstanding for this lane.
...
| `docs/agentic-notes/injectivity/INJECTIVITY_Y3_RESIDUALS.md` | new — 242 lines |
