...
(`docs/agentic-notes/v0.4.5/RENUMBERING_INSTABILITY_v0.4.5.md` — 43.9% of a 225-molecule sample drift under pure
...
Measured (`docs/agentic-notes/v0.4.5/VALENCE_ORDER_v0.4.5.md`):
...
|---|---|
| `docs/agentic-notes/v0.4.5/ENCODE_FAIL_v0.4.5.md` §5 | **"Confirmed unfixable: 34 boron clusters"**, *"needs a different bonding model entirely (multi-center bonds)"*, *"an encoder that refuses this input is correct, not a bug"*. **Refuted.** |
