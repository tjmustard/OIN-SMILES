...
`docs/agentic-notes/v0.4.5/VALENCE_SEARCH_v0.4.5.md` closed with a hypothesis it called "one lead that looks better
...
* **the real code path.** Every rank the DP predicted was then hit by production `AC2BO` on the
  ...
  **225**.
* **the sibling lane.** The probe reproduces `docs/agentic-notes/v0.4.5/VALENCE_SEARCH_v0.4.5.md`'s independently
...
`docs/agentic-notes/v0.4.5/VALENCE_SEARCH_v0.4.5.md` recorded, from its fine budget sweep on QIDKUL's ligand:
...
`docs/agentic-notes/v0.4.5/VALENCE_SEARCH_v0.4.5.md` grouped the population by ligand atom count and concluded the
...
The ligand-size split in `docs/agentic-notes/v0.4.5/VALENCE_SEARCH_v0.4.5.md` does not survive: **`KESWUB` at 188
...
`docs/agentic-notes/v0.4.5/VALENCE_SEARCH_v0.4.5.md` reported for `HICLAG`. That figure came from whole-encode wall
