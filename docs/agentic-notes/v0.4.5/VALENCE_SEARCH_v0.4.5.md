...
`docs/agentic-notes/v0.4.5/ENCODER_PERF_v0.4.5.md` (the `encspeed` lane) profiled the encoder for the first time
...
`docs/agentic-notes/v0.4.5/ENCODE_FAIL_v0.4.5.md` lists as *"unresolved this session — genuine encoder-side cost,
...
value `docs/agentic-notes/v0.4.5/ENCODER_PERF_v0.4.5.md` recorded independently** for this molecule, so the encode
...
`REPEAT-OK`, and the OIN sha `796221298c6c` again matches `docs/agentic-notes/v0.4.5/ENCODER_PERF_v0.4.5.md`
...
`nx.max_weight_matching` on a 16-node graph is **482.6 µs**; `docs/agentic-notes/v0.4.5/ENCODER_PERF_v0.4.5.md`
