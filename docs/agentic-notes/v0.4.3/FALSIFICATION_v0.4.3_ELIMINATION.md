...
| `tools/structure_distortion_report.py` | §1.4 / §4 geometric quality (+ `docs/agentic-notes/v0.4.3/DISTORTION_v0.4.3_RESEARCH.md`) |
...
From `docs/agentic-notes/v0.4.3/DISTORTION_v0.4.3_RESEARCH.md` (6,404 non-quick structures, crystal inputs as
...
which reads `docs/agentic-notes/v0.4.3/data/telemetry_events.json` (the 861-molecule run,
`tools/telemetry_run.py` output) and `docs/agentic-notes/v0.4.3/data/telemetry_strata.json` (the sample
