...
>
> The retrospective brief lists `docs/VALENCE_ORDER_v0.4.5.md`, `tests/unit/test_valence_order.py`,
...
> `docs/v0.4.5-retrospective/LANE-valence-search.md`, where it belongs.
>
...
> `docs/RENUMBERING_INSTABILITY_v0.4.5.md` (§"Follow-up, measured 2026-07-25"),
> `docs/PROMOTION_GATE_v0.4.5.md`, `docs/CANONICAL_OIN_v0.4.5.md` §"Known gaps" item 5,
...
> correction is recorded in `docs/V045_STATUS_2026-07-25.md` §"I tested the lane's own follow-up
