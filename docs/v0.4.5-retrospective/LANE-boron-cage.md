...
- `docs/ENCODER_ROBUSTNESS_v0.4.4_SL5.md` §W1 — *"RDKit cannot perceive a 3c-2e boron cage into a
  ...
  cages — out of scope)."*
- `docs/ENCODE_FAIL_v0.4.5.md` §5, titled **"Confirmed unfixable: 34 boron clusters"** — *"it
...
|---|---|
| `docs/BORON_CAGE_v0.4.5.md` | says "default OFF" throughout, and §4's opening *"Everything is behind `OIN_BORON_CAGE`, default OFF"*. True for v0.4.5, **false since `d799de1f`**. |
| `docs/ENCODE_FAIL_v0.4.5.md` §5 + §7 | *"Confirmed unfixable: 34 boron clusters"*, *"needs a different bonding model entirely"*, *"34 of 48 (70.8%) are an honest, correct ceiling"*. **Refuted by this lane** — the doc's own §7 header row "confirmed unfixable" should read 0. |
| `docs/ENCODER_ROBUSTNESS_v0.4.4_SL5.md` §W1 | the "irreducible ceiling" framing. Its test module docstring was corrected at promotion; the doc was not. |
...
3. **Not proven stable under renumbering.** These encode deterministically for their actual atom
   ...
   instability (`docs/RENUMBERING_INSTABILITY_v0.4.5.md`) has **not** been re-measured for cages.
