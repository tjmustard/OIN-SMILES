...
> `docs/VALENCE_ORDER_v0.4.5.md` as a source for the *other* lane in this pair. It is not:
...
Primary sources: `docs/VALENCE_SEARCH_v0.4.5.md`, `docs/VALENCE_ORDER_v0.4.5.md`,
`docs/ENCODER_PERF_v0.4.5.md`, `docs/ENCODE_FAIL_v0.4.5.md`,
...
The lane inherited three beliefs, two from `docs/ENCODER_PERF_v0.4.5.md` (the `encspeed`
...
`docs/ENCODE_FAIL_v0.4.5.md` classifies as `resonance_timeout` and describes as *"unresolved
...
clock. The OIN shas independently match the values `docs/ENCODER_PERF_v0.4.5.md` recorded for
...
`docs/ENCODER_PERF_v0.4.5.md` counted **60 001** calls; 60 001 × 482.6 µs = **29.0 s** against
...
`docs/VALENCE_SEARCH_v0.4.5.md`'s fine budget sweep recorded:
...
`docs/VALENCE_SEARCH_v0.4.5.md` grouped the over-cap population by ligand atom count and
