...
The 20-molecule stratified cohort (`docs/eta_accept_gap_cohort.md`):
...
extra passes. Full write-up in `docs/BORON_CAGE_v0.4.5.md` §10; that document's headline "34 now
