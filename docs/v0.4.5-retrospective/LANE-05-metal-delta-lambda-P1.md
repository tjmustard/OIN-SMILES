...
`docs/CANONICAL_OIN_v0.4.5.md` §4 and `docs/V045_STATUS_2026-07-25.md`:
...
The Y2 wave (`docs/INJECTIVITY_Y2_FEASIBILITY.md`) had recorded that RDKit's
...
|---|---|---|
| P1 is **key-blind**, the dangerous cell | `fac-Ir(ppy)3` and its mirror give different **raw** strings, but only by slot renumbering, which `_polyhedron_signature` deliberately folds ⇒ `raw_equal = False`, `key_equal = True` | `docs/INJECTIVITY_Y1_P1_METAL.md` |
...
docstrings, in `_ACHIRAL_RMSD_TOL`'s comment, and in `docs/V046_HFAITHFUL_FINDINGS.md` (the three
