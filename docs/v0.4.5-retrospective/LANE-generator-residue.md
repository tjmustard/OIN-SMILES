...
Primary sources: `docs/GEN_RESIDUE_v0.4.5.md`, commit `4dcb5284`,
`src/oinsmiles/generation/metallogen_adapter.py`, `docs/KNOWN_LIMITATIONS.md`,
`docs/INJECTIVITY_Y3_UNKNOWN_UNKNOWNS.md`, `docs/V046_HFAITHFUL_FINDINGS.md` §3,
`docs/CANONICAL_OIN_v0.4.5.md` §"The confound that governs every accuracy number here".
...
(`docs/FALSIFICATION_v0.4.3_ELIMINATION.md` §1.4) and that eta rings collapse to a centroid so the
...
also documented in `docs/ACCURACY_v0.4.1.md`, `docs/ACCURACY_v0.4.2.md`,
`docs/FALSIFICATION_v0.4.3_ELIMINATION.md`). MetalloGen's `metal|lig1|...|geo` m-SMILES **has no
...
> `docs/V046_HFAITHFUL_FINDINGS.md` §3 and the **0.4.6** CHANGELOG stanza — they postdate
> `docs/GEN_RESIDUE_v0.4.5.md` and are not in it. They are included here because they are the
