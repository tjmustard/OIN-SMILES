...
deliberate deferral in `docs/CANONICAL_OIN_v0.4.5.md` "Known gaps" §4 and in the release commit
...
`docs/PROMOTION_GATE_v0.4.5.md` §3 lists this lever under its charter name
...
Design document: `docs/LOCKED_DONOR_v0.4.5.md`.
...
`docs/LOCKED_DONOR_v0.4.5.md` (Lane 6) · `docs/V046_HFAITHFUL_FINDINGS.md` (Lane 5's four
formulations, and the P3 restoration negative result) ·
`docs/KNOWN_LIMITATIONS.md` "Encoder injectivity blind spots (Y1 audit)" ·
`docs/INJECTIVITY_Y1_P1_METAL.md`, `docs/INJECTIVITY_Y1_P3_AMINE.md` ·
