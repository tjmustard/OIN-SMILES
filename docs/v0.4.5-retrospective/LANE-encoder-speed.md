...
`docs/ENCODER_PERF_v0.4.5.md`. As with the perf lane,
...
The follow-on `valsearch` lane (`docs/VALENCE_SEARCH_v0.4.5.md`) then did exactly that, and its
...
Doc: `docs/ENCODER_PERF_v0.4.5.md`. Follow-on: `docs/VALENCE_SEARCH_v0.4.5.md`.
...
* **`docs/VALENCE_SEARCH_v0.4.5.md` states "`swimlane/v045-encspeed` is not merged into `main` —
...
* **`QIDKIZ_comp_0` is described as "1641.4 s, still unexplained" in `docs/PERF_v0.4.5.md`.** This
...
3. **The corpus-wide distribution of over-cap ligands is now partly known and should be finished.**
   ...
   with strong enrichment — 4 of the 7 molecules `docs/ENCODE_FAIL_v0.4.5.md` lists as unresolved
