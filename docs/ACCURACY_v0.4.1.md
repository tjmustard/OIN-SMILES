...
It is the companion to `docs/ACCURACY_v0.4.2.md` (which measures *per-molecule* what the v0.4.2 wave
...
`docs/ACCURACY_v0.4.2.md`, apply and are worth stating up front:
...
1. **`--quick` is a deliberately weak generator — 88.4 % is a *floor*, not the library's ceiling.**
   ...
   quick-budget artifacts that evaporate under the default generator (see `docs/ACCURACY_v0.4.2.md`).
...
- **Genuinely encoder/generator-fixable accuracy classes: ~700** — the E/Z, atom-stereo, donor-H,
  ...
  `docs/ACCURACY_v0.4.2.md` for the per-molecule before→after.
...
`--quick` fabricates geometric distortion. See `docs/ACCURACY_v0.4.2.md` for the methodology.
