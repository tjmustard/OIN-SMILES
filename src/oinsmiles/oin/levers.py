...
_HELD_OFF = {
    "OIN_CANONICAL_DONOR_FOLD": (
        ...
        "sphere), then re-run tools/mirror_audit_donor_fold.py on a UNIFORM draw -- not the "
        "runtime-stratified cohort, which is selected for slowness, carries little "
        "stereochemistry, and returned a clean bill for 200 molecules while the uniform draw was "
        "finding 19 collapses.\n"
